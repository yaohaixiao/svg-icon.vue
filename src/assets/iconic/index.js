...
const iconicSet = {
  title: 'Iconic 图标集',
  symbols: [
    '<symbol id="icon-iconic-chat" viewBox="0 0 32 32">' +
    ...
    '</symbol>',
    '<symbol id="icon-iconic-chat-alt-stroke" viewBox="0 0 32 32">' +
    ...
    '</symbol>',
    '<symbol id="icon-iconic-chat-alt-fill" viewBox="0 0 32 32">' +
    ...
    '</symbol>',
    '<symbol id="icon-iconic-comment-alt1-stroke" viewBox="0 0 32 32">' +
    '<path d="M16.002 8c11.072 0 11.998 4.129 11.998 8 0 1.344-0.355 2.805-0.746 4h-13.25c-4.703 0-6.738 0.195-9 1.758-0.938-2.57-1.539-6.047-0.379-8.84 1.351-3.262 5.179-4.918 11.377-4.918M16.002 4c-22.371 0-15.991 20-11.996 24 4-4 4-4 9.996-4h15.935c0 0 2.063-4 2.063-8 0-10-7.997-12-15.998-12v0z"></path>' +
    '</symbol>',
    '<symbol id="icon-iconic-comment" viewBox="0 0 32 32">' +
    ...
    '</symbol>',
    '<symbol id="icon-iconic-comment-stroke" viewBox="0 0 32 32">' +
    '<path d="M20 6c4.414 0 8 3.586 8 8s-3.586 8-8 8h-8c-2.609 0-4.934 1.258-6.395 3.203-0.972-0.734-1.605-1.898-1.605-3.203v-10c0-3.309 2.695-6 6-6h10M20 2h-10c-5.523 0-10 4.477-10 10v10c0 4.418 3.586 8 8 8 0-2.211 1.793-4 4-4h8c6.629 0 12-5.375 12-12s-5.371-12-12-12v0z"></path>' +
    '</symbol>',
    '<symbol id="icon-iconic-comment-fill" viewBox="0 0 32 32">' +
    ...
    '</symbol>',
    '<symbol id="icon-iconic-comment-alt2-stroke" viewBox="0 0 28 32">' +
    ...
    '</symbol>',
    '<symbol id="icon-iconic-comment-alt2-fill" viewBox="0 0 28 32">' +
    ...
    '</symbol>',
    '<symbol id="icon-iconic-checkmark" viewBox="0 0 32 32">' +
    '<path d="M6 12l-6 6 12 12 20-20-6-6-14 14z"></path>' +
    '</symbol>',
    '<symbol id="icon-iconic-check-alt" viewBox="0 0 32 32">' +
    ...
    '</symbol>',
    '<symbol id="icon-iconic-x" viewBox="0 0 32 32">' +
    '<path d="M30 24.398l-8.406-8.398 8.406-8.398-5.602-5.602-8.398 8.402-8.402-8.402-5.598 5.602 8.398 8.398-8.398 8.398 5.598 5.602 8.402-8.402 8.398 8.402z"></path>' +
    '</symbol>',
    '<symbol id="icon-iconic-x-altx-alt" viewBox="0 0 32 32">' +
    ...
    '</symbol>',
    '<symbol id="icon-iconic-denied" viewBox="0 0 32 32">' +
    ...
    '</symbol>',
    '<symbol id="icon-iconic-dial" viewBox="0 0 32 32">' +
    ...
    '</symbol>',
    '<symbol id="icon-iconic-cog" viewBox="0 0 32 32">' +
    ...
    '</symbol>',
    '<symbol id="icon-iconic-calendar" viewBox="0 0 32 32">' +
    '<path d="M24 4v-4h-4v4h-8v-4h-4v4h-8v4h32v-4zM4 20h24v4h-24zM4 12h24v4h-24zM4 32h20l4-4h-24z"></path>' +
    '</symbol>',
    '<symbol id="icon-iconic-calendar-alt-stroke" viewBox="0 0 32 32">' +
    '<path d="M32 32h-32v-28h4v24h24v-24h4zM6 12h4v4h-4zM14 12h4v4h-4zM22 12h4v4h-4zM6 20h4v4h-4zM14 20h4v4h-4zM22 24v-4h4zM8 6v-4c0-1.105 0.895-2 2-2s2 0.895 2 2v4c0 1.105-0.895 2-2 2s-2-0.895-2-2zM20 6v-4c0-1.105 0.895-2 2-2s2 0.895 2 2v4c0 1.105-0.895 2-2 2s-2-0.895-2-2z"></path>' +
    '</symbol>',
    '<symbol id="icon-iconic-calendar-alt-fill" viewBox="0 0 32 32">' +
    ...
    '</symbol>',
    '<symbol id="icon-iconic-movie" viewBox="0 0 32 32">' +
    '<path d="M27.977 8h-3.949l3.972-3.984-3.926-4.016h-5.566l3.988 3.984-4.086 4.016h-4.723l4.059-3.984-4.012-4.016h-5.656l3.984 3.984-4.085 4.016h-4.008l4.062-3.984-4.015-4.016h-4.016v32h32v-32h-3.922l3.922 4-4.023 4zM28 28h-24v-4h24v4zM28 20h-24v-4h24v4z"></path>' +
    '</symbol>',
    '<symbol id="icon-iconic-document-alt-stroke" viewBox="0 0 24 32">' +
    '<path d="M14 0h-14v32h24v-22.002l-10-9.998zM4 28v-24h8v8h8v16h-16z"></path>' +
    '</symbol>',
    '<symbol id="icon-iconic-document-alt-fill" viewBox="0 0 24 32">' +
    '<path d="M14 0h-14v32h24v-22.002l-10-9.998zM11.918 12v-8l8 8h-8z"></path>' +
    '</symbol>',
    '<symbol id="icon-iconic-document-stroke" viewBox="0 0 32 32">' +
    '<path d="M22.016 0h-22.016v31.938l8.051-6.578 8.019 6.64 8.012-6.633 7.918 6.617v-21.984l-9.984-10zM28.020 23.938l-3.953-3.227-7.996 6.617-7.98-6.609-4.086 3.219c0 0 0-17.359 0-20 2.102 0 7.809 0 12.008 0v12h12.007c0 2.73 0 8 0 8zM20.016 11.938c0-1.543 0-5.914 0-8 1.617 1.617 6.402 6.398 8.004 8-2.047 0-6.45 0-8.004 0z"></path>' +
    '</symbol>',
    '<symbol id="icon-iconic-document-fill" viewBox="0 0 32 32">' +
    ...
    '</symbol>',
    '<symbol id="icon-iconic-plus" viewBox="0 0 32 32">' +
    '<path d="M32 12h-12v-12h-8v12h-12v8h12v12h8v-12h12z"></path>' +
    '</symbol>',
    '<symbol id="icon-iconic-plus-alt" viewBox="0 0 32 32">' +
    ...
    '</symbol>',
    '<symbol id="icon-iconic-minus" viewBox="0 0 32 32">' +
    '<path d="M0 12h32v8h-32z"></path>' +
    '</symbol>',
    '<symbol id="icon-iconic-minus-alt" viewBox="0 0 32 32">' +
    '<path d="M16 0c-8.836 0-16 7.164-16 16s7.164 16 16 16 16-7.164 16-16-7.164-16-16-16zM24 18h-16v-4h16v4z"></path>' +
    '</symbol>',
    '<symbol id="icon-iconic-pin" viewBox="0 0 32 32">' +
    '<path d="M32 8c0-4.416-3.586-8-8-8-2.984 0-5.562 1.658-6.938 4.086 0-0.002 0.004-0.004 0.004-0.006-0.367-0.035-0.723-0.111-1.098-0.111-6.629 0-12 5.371-12 12 0 2.527 0.789 4.867 2.121 6.797l-6.089 9.234 9.289-6.062c1.91 1.281 4.207 2.031 6.68 2.031 6.629 0 12-5.371 12-12 0-0.346-0.070-0.67-0.102-1.008 2.453-1.367 4.133-3.955 4.133-6.961zM15.969 23.969c-4.414 0-8-3.586-8-8 0-4.412 3.586-8 8-8 0.012 0 0.023 0.004 0.031 0.004 0-0.008 0.004-0.014 0.004-0.020 0 0.016-0.004 0.031-0.004 0.047 0 0.695 0.117 1.355 0.281 1.998l-3.172 3.174c-1.562 1.562-1.562 4.094 0 5.656s4.094 1.562 5.656 0l3.141-3.141c0.66 0.18 1.344 0.305 2.059 0.309-0.016 4.402-3.594 7.973-7.996 7.973zM24 12c-2.203 0-4-1.795-4-4s1.797-4 4-4 4 1.795 4 4-1.797 4-4 4z"></path>' +
    '</symbol>',
    '<symbol id="icon-iconic-link" viewBox="0 0 32 32">' +
    '<path d="M31.414 0.586c-0.781-0.781-2.059-0.781-2.84 0l-4.070 4.074c-1.668-1.109-3.582-1.66-5.504-1.66-2.559 0-5.117 0.977-7.070 2.93l-6 6c-3.422 3.418-3.844 8.703-1.273 12.582l-4.070 4.074c-0.781 0.781-0.781 2.047 0 2.828 0.39 0.391 0.901 0.586 1.413 0.586s1.023-0.195 1.414-0.586l4.070-4.074c1.668 1.109 3.594 1.66 5.516 1.66 2.559 0 5.117-0.977 7.070-2.93l5.988-6c3.422-3.418 3.844-8.703 1.273-12.582l4.082-4.074c0.782-0.781 0.782-2.047 0.001-2.828zM24.988 13c0 1.602-0.625 3.109-1.758 4.242l-5.988 6c-1.133 1.133-2.64 1.758-4.242 1.758-0.906 0-1.773-0.223-2.57-0.602l2.984-2.984c0.781-0.781 0.781-2.047 0-2.828s-2.047-0.781-2.828 0l-2.984 2.984c-0.383-0.793-0.602-1.66-0.602-2.57 0-1.602 0.625-3.109 1.758-4.242l6-6c1.133-1.133 2.64-1.758 4.242-1.758 0.906 0 1.77 0.223 2.566 0.602l-3.043 3.047c-0.781 0.781-0.781 2.047 0 2.828 0.391 0.391 0.902 0.586 1.414 0.586 0.508 0 1.020-0.195 1.41-0.586l3.039-3.047c0.384 0.793 0.602 1.66 0.602 2.57z"></path>' +
    '</symbol>',
    '<symbol id="icon-iconic-bolt" viewBox="0 0 32 32">' +
    '<path d="M32 0l-24 16 6 4-14 12 24-12-6-4z"></path>' +
    '</symbol>',
    '<symbol id="icon-iconic-move" viewBox="0 0 32 32">' +
    '<path d="M18 20v6h4l-6 6-6-6h4v-6zM14 12v-6h-4l6-6 6 6h-4v6zM12 18h-6v4l-6-6 6-6v4h6zM20 14h6v-4l6 6-6 6v-4h-6z"></path>' +
    '</symbol>',
    '<symbol id="icon-iconic-move-alt1" viewBox="0 0 32 32">' +
    '<path d="M16 22l2-2v6h4l-6 6-6-6h4v-6zM16 10.062l-2 1.938v-6h-4l6-6 6 6h-4v6zM10 16l2 2h-6v4l-6-6 6-6v4h6zM21.938 16l-1.938-2h6v-4l6 6-6 6v-4h-6z"></path>' +
    '</symbol>',
    '<symbol id="icon-iconic-move-alt2" viewBox="0 0 32 32">' +
    '<path d="M16 0c-8.836 0-16 7.164-16 16s7.164 16 16 16 16-7.164 16-16-7.164-16-16-16zM22 20v-2h-4v4h2l-4 4-4-4h2v-4h-4v2l-4-4 4-4v2h4v-4h-2l4-4 4 4h-2v4h4v-2l4 4-4 4z"></path>' +
    '</symbol>',
    '<symbol id="icon-iconic-equalizer" viewBox="0 0 32 32">' +
    ...
    '</symbol>',
    '<symbol id="icon-iconic-award-fill" viewBox="0 0 16 32">' +
    ...
    '</symbol>',
    '<symbol id="icon-iconic-award-stroke" viewBox="0 0 16 32">' +
    ...
    '</symbol>',
    '<symbol id="icon-iconic-magnifying-glass" viewBox="0 0 32 32">' +
    ...
    '</symbol>',
    '<symbol id="icon-iconic-trash-stroke" viewBox="0 0 32 32">' +
    ...
    '</symbol>',
    '<symbol id="icon-iconic-trash-fill" viewBox="0 0 32 32">' +
    ...
    '</symbol>',
    '<symbol id="icon-iconic-beaker-alt" viewBox="0 0 16 32">' +
    '<path d="M8 9c0-0.552 0.448-1 1-1s1 0.448 1 1c0 0.552-0.448 1-1 1s-1-0.448-1-1zM14 0h-12c-1.105 0-2 0.895-2 2v22c0 4.418 3.582 8 8 8s8-3.582 8-8v-22c0-1.105-0.895-2-2-2zM5 20c-0.552 0-1-0.447-1-1s0.448-1 1-1c0.553 0 1 0.447 1 1s-0.447 1-1 1zM10 24c-1.105 0-2-0.895-2-2s0.895-2 2-2 2 0.895 2 2-0.895 2-2 2zM12 16h-2c0-1.104-0.896-2-2-2s-2 0.896-2 2h-2v-12h8v12z"></path>' +
    '</symbol>',
    '<symbol id="icon-iconic-beaker" viewBox="0 0 16 32">' +
    '<path d="M14 0h-12c-1.105 0-2 0.895-2 2v22c0 4.418 3.582 8 8 8s8-3.582 8-8v-22c0-1.105-0.895-2-2-2zM10 24c-1.105 0-2-0.895-2-2s0.895-2 2-2 2 0.895 2 2-0.895 2-2 2zM12 16h-2c0-1.104-0.896-2-2-2s-2 0.896-2 2h-2v-12h8v12z"></path>' +
    '</symbol>',
    '<symbol id="icon-iconic-key-stroke" viewBox="0 0 32 32">' +
    '<path d="M22 0c-5.523 0-10 4.477-10 10 0 0.625 0.074 1.227 0.184 1.816l-12.184 12.184v8h12v-4h4v-4h4v-4l0.184-0.184c0.589 0.11 1.191 0.184 1.816 0.184 5.523 0 10-4.477 10-10s-4.477-10-10-10zM22 16c-0.313 0-0.656-0.039-1.086-0.117l-2.070-0.383-2.844 2.844v1.656h-4v4h-4v4h-4v-2.344l12.5-12.5-0.383-2.070c-0.080-0.43-0.117-0.774-0.117-1.086 0-3.309 2.691-6 6-6s6 2.691 6 6-2.691 6-6 6zM20 10c0-1.105 0.895-2 2-2s2 0.895 2 2c0 1.105-0.895 2-2 2s-2-0.895-2-2z"></path>' +
    '</symbol>',
    '<symbol id="icon-iconic-key-fill" viewBox="0 0 32 32">' +
    ...
    '</symbol>',
    '<symbol id="icon-iconic-spin-alt" viewBox="0 0 32 32">' +
    ...
    '</symbol>',
    '<symbol id="icon-iconic-spin" viewBox="0 0 28 32">' +
    ...
    '</symbol>',
    '<symbol id="icon-iconic-reload" viewBox="0 0 32 32">' +
    ...
    '</symbol>',
    '<symbol id="icon-iconic-reload-alt" viewBox="0 0 32 32">' +
    ...
    '</symbol>',
    '<symbol id="icon-iconic-loop" viewBox="0 0 32 32">' +
    ...
    '</symbol>',
    '<symbol id="icon-iconic-loop-alt1" viewBox="0 0 32 32">' +
    ...
    '</symbol>',
    '<symbol id="icon-iconic-loop-alt2" viewBox="0 0 32 32">' +
    ...
    '</symbol>',
    '<symbol id="icon-iconic-loop-alt3" viewBox="0 0 32 32">' +
    ...
    '</symbol>',
    '<symbol id="icon-iconic-loop-alt4" viewBox="0 0 32 32">' +
    '<path d="M28 18c0 1.102-0.898 2-2 2h-18.008v-4l-7.992 6 7.992 6v-4h18.008c3.309 0 6-2.695 6-6h-4zM6 12h18v4l8-6-8-6v4h-18c-3.309 0-6 2.688-6 6h4c0-1.102 0.898-2 2-2z"></path>' +
    '</symbol>',
    '<symbol id="icon-iconic-transfer" viewBox="0 0 32 32">' +
    '<path d="M31.998 24h-24.006v4l-7.992-6 7.992-6v4h24.006zM0 12h23.998v4l8-6-8-6v4h-23.998z"></path>' +
    '</symbol>',
    '<symbol id="icon-iconic-move-vertical" viewBox="0 0 12 32">' +
    '<path d="M8 20v6h4l-6 6-6-6h4v-6zM4 12v-6h-4l6-6 6 6h-4v6z"></path>' +
    '</symbol>',
    '<symbol id="icon-iconic-move-vertical-alt1" viewBox="0 0 12 32">' +
    '<path d="M6 22l2-2v6h4l-6 6-6-6h4v-6zM6 10.062l-2 1.938v-6h-4l6-6 6 6h-4v6z"></path>' +
    '</symbol>',
    '<symbol id="icon-iconic-move-vertical-alt2" viewBox="0 0 32 32">' +
    '<path d="M16 0c-8.836 0-16 7.164-16 16s7.164 16 16 16 16-7.164 16-16-7.164-16-16-16zM18 22h2l-4 4-4-4h2v-12h-2l4-4 4 4h-2v12z"></path>' +
    '</symbol>',
    '<symbol id="icon-iconic-move-horizontal" viewBox="0 0 32 32">' +
    '<path d="M12 18h-6v4l-6-6 6-6v4h6zM20 14h6v-4l6 6-6 6v-4h-6z"></path>' +
    '</symbol>',
    '<symbol id="icon-iconic-move-horizontal-alt1" viewBox="0 0 32 32">' +
    '<path d="M10 16l2 2h-6v4l-6-6 6-6v4h6zM21.938 16l-1.938-2h6v-4l6 6-6 6v-4h-6z"></path>' +
    '</symbol>',
    '<symbol id="icon-iconic-move-horizontal-alt2" viewBox="0 0 32 32">' +
    ...
    '</symbol>',
    '<symbol id="icon-iconic-arrow-left" viewBox="0 0 32 32">' +
    '<path d="M32 12h-16l6-6-6-6-16 16 16 16 6-6-6-6h16z"></path>' +
    '</symbol>',
    '<symbol id="icon-iconic-arrow-left-alt1" viewBox="0 0 32 32">' +
    ...
    '</symbol>',
    '<symbol id="icon-iconic-arrow-left-alt2" viewBox="0 0 32 32">' +
    '<path d="M16 32c8.836 0 16-7.164 16-16s-7.164-16-16-16-16 7.164-16 16 7.164 16 16 16zM10 12v2h16v4h-16v2l-4-4 4-4z"></path>' +
    '</symbol>',
    '<symbol id="icon-iconic-arrow-right" viewBox="0 0 32 32">' +
    ...
    '</symbol>',
    '<symbol id="icon-iconic-arrow-right-alt2" viewBox="0 0 32 32">' +
    '<path d="M16 0c-8.836 0-16 7.164-16 16s7.164 16 16 16 16-7.164 16-16-7.164-16-16-16zM22 20v-2h-16v-4h16v-2l4 4-4 4z"></path>' +
    '</symbol>',
    '<symbol id="icon-iconic-arrow-up" viewBox="0 0 32 32">' +
    '<path d="M20 32v-16l6 6 6-6-16-16-16 16 6 6 6-6v16z"></path>' +
    '</symbol>',
    '<symbol id="icon-iconic-arrow-up-alt1" viewBox="0 0 32 32">' +
    '<path d="M16 32c8.836 0 16-7.164 16-16 0-8.837-7.164-16-16-16-8.837 0-16 7.163-16 16 0 8.836 7.163 16 16 16zM16 8l8 8h-6v8h-4v-8h-6l8-8z"></path>' +
    '</symbol>',
    '<symbol id="icon-iconic-arrow-up-alt2" viewBox="0 0 32 32">' +
    '<path d="M0 16c0 8.836 7.164 16 16 16s16-7.164 16-16-7.164-16-16-16-16 7.164-16 16zM20 10h-2v16h-4v-16h-2l4-4 4 4z"></path>' +
    '</symbol>',
    '<symbol id="icon-iconic-arrow-down" viewBox="0 0 32 32">' +
    '<path d="M12 0v16l-6-6-6 6 16 16 16-16-6-6-6 6v-16z"></path>' +
    '</symbol>',
    '<symbol id="icon-iconic-arrow-down-alt1" viewBox="0 0 32 32">' +
    ...
    '</symbol>',
    '<symbol id="icon-iconic-steering-wheel" viewBox="0 0 32 32">' +
    ...
    '</symbol>',
    '<symbol id="icon-iconic-microphone" viewBox="0 0 24 32">' +
    ...
    '</symbol>',
    '<symbol id="icon-iconic-headphones" viewBox="0 0 32 32">' +
    ...
    '</symbol>',
    '<symbol id="icon-iconic-volume" viewBox="0 0 32 32">' +
    '<path d="M8 24c-4.418 0-8-3.582-8-8s3.582-8 8-8v16zM12 8l8-4v24l-8-4zM24.004 23.996v-4c0.332 0 0.668-0.043 1.004-0.125 1.754-0.445 2.992-2.039 2.992-3.871s-1.238-3.422-3.012-3.871c-0.316-0.078-0.652-0.121-0.984-0.121v-4c0.656 0 1.313 0.082 1.957 0.238 3.559 0.906 6.039 4.090 6.039 7.754 0 3.668-2.48 6.855-6.027 7.754-0.664 0.16-1.321 0.242-1.969 0.242v0z"></path>' +
    '</symbol>',
    '<symbol id="icon-iconic-volume-mute" viewBox="0 0 32 32">' +
    '<path d="M8 24c-4.418 0-8-3.582-8-8s3.582-8 8-8v16zM12 8l8-4v24l-8-4zM32 18h-8v-4h8z"></path>' +
    '</symbol>',
    '<symbol id="icon-iconic-play" viewBox="0 0 24 32">' +
    '<path d="M0 0l24 16-24 16z"></path>' +
    '</symbol>',
    '<symbol id="icon-iconic-pause" viewBox="0 0 24 32">' +
    '<path d="M0 0h8v32h-8zM16 0h8v32h-8z"></path>' +
    '</symbol>',
    '<symbol id="icon-iconic-stop" viewBox="0 0 32 32">' +
    '<path d="M0 0h32v32h-32z"></path>' +
    '</symbol>',
    '<symbol id="icon-iconic-eject" viewBox="0 0 32 32">' +
    '<path d="M0 20l16-20 16 20zM0 24h31.957v8h-31.957z"></path>' +
    '</symbol>',
    '<symbol id="icon-iconic-first" viewBox="0 0 32 32">' +
    '<path d="M32 32l-24-16 24-16zM0 4h8v24h-8z"></path>' +
    '</symbol>',
    '<symbol id="icon-iconic-last" viewBox="0 0 32 32">' +
    '<path d="M0 0l24 16-24 16zM24 4h8v24h-8z"></path>' +
    '</symbol>',
    '<symbol id="icon-iconic-play-alt" viewBox="0 0 32 32">' +
    '<path d="M16 0c-8.836 0-16 7.164-16 16s7.164 16 16 16 16-7.164 16-16-7.164-16-16-16zM10 24v-16l16.008 8-16.008 8z"></path>' +
    '</symbol>',
    '<symbol id="icon-iconic-fullscreen-exit" viewBox="0 0 32 32">' +
    ...
    '</symbol>',
    '<symbol id="icon-iconic-fullscreen-exit-alt" viewBox="0 0 32 32">' +
    ...
    '</symbol>',
    '<symbol id="icon-iconic-fullscreen" viewBox="0 0 32 32">' +
    ...
    '</symbol>',
    '<symbol id="icon-iconic-fullscreen-alt" viewBox="0 0 32 32">' +
    ...
    '</symbol>',
    '<symbol id="icon-iconic-iphone" viewBox="0 0 24 32">' +
    ...
    '</symbol>',
    '<symbol id="icon-iconic-battery-empty" viewBox="0 0 32 32">' +
    '<path d="M32 12h-4v-2c0-1.098-0.898-2-2-2h-24c-1.102 0-2 0.902-2 2v12c0 1.098 0.898 2 2 2h24c1.102 0 2-0.902 2-2v-2h4v-8zM24 20h-20v-8h20v8z"></path>' +
    '</symbol>',
    '<symbol id="icon-iconic-battery-half" viewBox="0 0 32 32">' +
    ...
    '</symbol>',
    '<symbol id="icon-iconic-battery-full" viewBox="0 0 32 32">' +
    '<path d="M28 12v-2c0-1.1-0.9-2-2-2h-24c-1.1 0-2 0.9-2 2v12c0 1.1 0.9 2 2 2h24c1.1 0 2-0.9 2-2v-2h4v-8h-4z"></path>' +
    '</symbol>',
    '<symbol id="icon-iconic-battery-charging" viewBox="0 0 32 32">' +
    ...
    '</symbol>',
    '<symbol id="icon-iconic-compass" viewBox="0 0 32 32">' +
    '<path d="M18.125 13.879c0.797 0.799 1.008 1.93 0.719 2.943l5.156-8.822-8.703 5.139c0.984-0.243 2.058-0.030 2.828 0.74zM13.883 18.121c-0.773-0.771-0.984-1.85-0.742-2.836l-5.141 8.715 8.832-5.16c-1.016 0.293-2.148 0.082-2.949-0.719zM16 4c6.617 0 12 5.383 12 12s-5.383 12-12 12-12-5.383-12-12 5.383-12 12-12M16 0c-8.836 0-16 7.164-16 16s7.164 16 16 16 16-7.164 16-16-7.164-16-16-16v0z"></path>' +
    '</symbol>',
    '<symbol id="icon-iconic-box" viewBox="0 0 32 32">' +
    '<path d="M0 12h32v20h-32zM18 8h14l-4-8h-10zM14 0h-10l-4 8h14z"></path>' +
    '</symbol>',
    '<symbol id="icon-iconic-folder-stroke" viewBox="0 0 32 32">' +
    '<path d="M16 4.002v-4.002h-16v28c0 2.211 1.789 4 4 4h24c2.207 0 4-1.789 4-4v-23.998h-16zM28 16.004v11.996h-24v-12l24 0.004zM28 12h-24v-8l8 0.002v3.998h16v4z"></path>' +
    '</symbol>',
    '<symbol id="icon-iconic-folder-fill" viewBox="0 0 32 32">' +
    '<path d="M32 30c0 1.105-0.895 2-2 2h-28c-1.105 0-2-0.895-2-2v-18h32v18zM12 4.002v-4.002h-12v8h32v-3.998z"></path>' +
    '</symbol>',
    '<symbol id="icon-iconic-at" viewBox="0 0 32 32">' +
    ...
    '</symbol>',
    '<symbol id="icon-iconic-ampersand" viewBox="0 0 19 32">' +
    ...
    '</symbol>',
    '<symbol id="icon-iconic-info" viewBox="0 0 16 32">' +
    ...
    '</symbol>',
    '<symbol id="icon-iconic-question-mark" viewBox="0 0 16 32">' +
    ...
    '</symbol>',
    '<symbol id="icon-iconic-pilcrow" viewBox="0 0 24 32">' +
    '<path d="M24 0h-16c-4.418 0-8 3.582-8 8s3.582 8 8 8v16h4v-28h4v28h4v-28h4v-4z"></path>' +
    '</symbol>',
    '<symbol id="icon-iconic-hash" viewBox="0 0 28 32">' +
    ...
    '</symbol>',
    '<symbol id="icon-iconic-left-quote" viewBox="0 0 32 32">' +
    ...
    '</symbol>',
    '<symbol id="icon-iconic-right-quote" viewBox="0 0 32 32">' +
    ...
    '</symbol>',
    '<symbol id="icon-iconic-left-quote-alt" viewBox="0 0 32 32">' +
    '<path d="M32 28v-24l-12 12v12zM12 28v-24l-12 12v12z"></path>' +
    '</symbol>',
    '<symbol id="icon-iconic-right-quote-alt" viewBox="0 0 32 32">' +
    '<path d="M0 4v24l12-12v-12zM20 4v24l12-12v-12z"></path>' +
    '</symbol>',
    '<symbol id="icon-iconic-article" viewBox="0 0 32 32">' +
    ...
    '</symbol>',
    '<symbol id="icon-iconic-read-more" viewBox="0 0 32 32">' +
    '<path d="M32 4h-32v-4h32zM20 12h-20v-4h20zM32 20h-32v-4h32zM0 30c0-1.105 0.895-2 2-2s2 0.895 2 2c0 1.105-0.895 2-2 2s-2-0.895-2-2zM16 30c0-1.105 0.895-2 2-2s2 0.895 2 2c0 1.105-0.895 2-2 2s-2-0.895-2-2zM8 30c0-1.105 0.895-2 2-2s2 0.895 2 2c0 1.105-0.895 2-2 2s-2-0.895-2-2z"></path>' +
    '</symbol>',
    '<symbol id="icon-iconic-list" viewBox="0 0 37 32">' +
    ...
    '</symbol>',
    '<symbol id="icon-iconic-list-nested" viewBox="0 0 37 32">' +
    ...
    '</symbol>',
    '<symbol id="icon-iconic-book" viewBox="0 0 28 32">' +
    '<path d="M4 0c-2.2 0-4 1.8-4 4v24c0 2.2 1.8 4 4 4h24v-32h-24zM24 28h-16v-24h4v8l4-4 4 4v-8h4v24z"></path>' +
    '</symbol>',
    '<symbol id="icon-iconic-book-alt" viewBox="0 0 32 32">' +
    '<path d="M32 4h-4v-4h-24c-2.2 0-4 1.8-4 4v24c0 2.2 1.8 4 4 4h24v-20h4l-4-4 4-4zM24 28h-16v-24h16v24zM12 8h8v4h-8z"></path>' +
    '</symbol>',
    '<symbol id="icon-iconic-book-alt2" viewBox="0 0 32 32">' +
    ...
    '</symbol>',
    '<symbol id="icon-iconic-pen" viewBox="0 0 32 32">' +
    '<path d="M29.656 2.344c-1.558-1.563-3.605-2.344-5.656-2.344-2.047 0-4.094 0.781-5.656 2.344l-18.313 18.312-0.031 11.344h11.312l18.344-18.344c3.125-3.125 3.125-8.187 0-11.312zM9.656 28h-1.656v-4h-3.977l0.004-1.68 17.145-17.148 5.656 5.656-17.172 17.172z"></path>' +
    '</symbol>',
    '<symbol id="icon-iconic-pen-alt-stroke" viewBox="0 0 32 32">' +
    ...
    '</symbol>',
    '<symbol id="icon-iconic-pen-alt-fill" viewBox="0 0 32 32">' +
    ...
    '</symbol>',
    '<symbol id="icon-iconic-pen-alt2" viewBox="0 0 32 32">' +
    ...
    '</symbol>',
    '<symbol id="icon-iconic-brush" viewBox="0 0 32 32">' +
    ...
    '</symbol>',
    '<symbol id="icon-iconic-brush-alt" viewBox="0 0 32 32">' +
    ...
    '</symbol>',
    '<symbol id="icon-iconic-eyedropper" viewBox="0 0 32 32">' +
    ...
    '</symbol>',
    '<symbol id="icon-iconic-layers-alt" viewBox="0 0 32 32">' +
    '<path d="M0 24l16.001 4 15.999-4v4l-15.999 4-16.001-4zM0 16l16.001 4 15.999-4v4l-15.999 4-16.001-4zM0 8l16.001 4 15.999-4v4l-15.999 4-16.001-4zM0 0l16.001 4 15.999-4v4l-15.999 4-16.001-4z"></path>' +
    '</symbol>',
    '<symbol id="icon-iconic-layers" viewBox="0 0 32 32">' +
    ...
    '</symbol>',
    '<symbol id="icon-iconic-image" viewBox="0 0 32 32">' +
    '<path d="M8 24v-8l4-4 4 4 8-8 8 8v8zM4 28v-28l-4 4v28h28l4-4z"></path>' +
    '</symbol>',
    '<symbol id="icon-iconic-camera" viewBox="0 0 32 32">' +
    ...
    '</symbol>',
    '<symbol id="icon-iconic-chart-alt" viewBox="0 0 30 32">' +
    '<path d="M14.533 19.422l-10.578-10.578c-5.273 6.086-5.273 15.070 0 21.156l10.578-10.578zM16 18v-18c-4.906 0.305-9.328 2.18-12.897 5.102l12.897 12.898zM18.002 4.016v14.812l-10.383 10.383c2.328 1.711 5.133 2.789 8.235 2.789 7.818 0 14.146-6.328 14.146-14.133 0-7.078-5.227-12.812-11.998-13.851z"></path>' +
    '</symbol>',
    '<symbol id="icon-iconic-bars" viewBox="0 0 32 32">' +
    '<path d="M24 0h8v32h-8zM12 8h8v24h-8zM0 16h8v16h-8z"></path>' +
    '</symbol>',
    '<symbol id="icon-iconic-bars-alt" viewBox="0 0 28 32">' +
    '<path d="M24 0h4v32h-4zM16 8h4v24h-4zM8 16h4v16h-4zM0 24h4v8h-4z"></path>' +
    '</symbol>',
    '<symbol id="icon-iconic-eye" viewBox="0 0 32 32">' +
    ...
    '</symbol>',
    '<symbol id="icon-iconic-user" viewBox="0 0 24 32">' +
    ...
    '</symbol>',
    '<symbol id="icon-iconic-home" viewBox="0 0 32 32">' +
    '<path d="M16 0l-16 16h4v16h24v-16h4l-16-16zM24 28h-6v-6h-4v6h-6v-14.344l8-5.656 8 5.656v14.344z"></path>' +
    '</symbol>',
    '<symbol id="icon-iconic-clock" viewBox="0 0 32 32">' +
    '<path d="M16 4c6.617 0 12 5.383 12 12s-5.383 12-12 12-12-5.383-12-12 5.383-12 12-12M16 0c-8.836 0-16 7.164-16 16s7.164 16 16 16 16-7.164 16-16-7.164-16-16-16v0zM21.422 18.578l-3.422-3.426v-7.152h-4.023v7.992c0 0.602 0.277 1.121 0.695 1.492l3.922 3.922 2.828-2.828z"></path>' +
    '</symbol>',
    '<symbol id="icon-iconic-lock-stroke" viewBox="0 0 24 32">' +
    ...
    '</symbol>',
    '<symbol id="icon-iconic-lock-fill" viewBox="0 0 24 32">' +
    '<path d="M14 0c-5.508 0-9.996 4.484-9.996 10v2h-4.004v14c0 3.309 2.691 6 6 6h12c3.309 0 6-2.691 6-6v-16c0-5.516-4.488-10-10-10zM11.996 24c-1.101 0-1.996-0.895-1.996-2s0.895-2 1.996-2c1.105 0 2 0.895 2 2s-0.894 2-2 2zM20 12h-11.996v-2c0-3.309 2.691-6 5.996-6 3.309 0 6 2.691 6 6v2z"></path>' +
    '</symbol>',
    '<symbol id="icon-iconic-unlock-stroke" viewBox="0 0 24 32">' +
    ...
    '</symbol>',
    '<symbol id="icon-iconic-unlock-fill" viewBox="0 0 24 32">' +
    '<path d="M14.004 0c-5.516 0-9.996 4.484-9.996 10h3.996c0-3.309 2.688-6 6-6 3.305 0 5.996 2.691 5.996 6v2h-20v14c0 3.309 2.695 6 6 6h12c3.305 0 6-2.691 6-6v-16c0-5.516-4.488-10-9.996-10zM12 24c-1.102 0-2-0.895-2-2s0.898-2 2-2c1.109 0 2 0.895 2 2s-0.891 2-2 2z"></path>' +
    '</symbol>',
    '<symbol id="icon-iconic-tag-stroke" viewBox="0 0 32 32">' +
    '<path d="M0 0v13.273l18.727 18.727c0 0 0-10.793 0-13.27 2.477 0 13.273 0 13.273 0l-18.727-18.73h-13.273zM11.797 3.562c0.773 0.77 7.879 7.883 11.602 11.605-3.102 0-8.234 0-8.234 0s0 5.133 0 8.227c-3.724-3.718-10.829-10.828-11.603-11.593 0-1.055 0-5.961 0-8.238 2.278-0.001 7.18-0.001 8.235-0.001zM11.699 8.613c0 1.703-1.383 3.086-3.082 3.086-1.703 0-3.086-1.383-3.086-3.086 0-1.699 1.383-3.078 3.086-3.078 1.699 0 3.082 1.379 3.082 3.078z"></path>' +
    '</symbol>',
    '<symbol id="icon-iconic-tag-fill" viewBox="0 0 32 32">' +
    ...
    '</symbol>',
    '<symbol id="icon-iconic-sun-stroke" viewBox="0 0 32 32">' +
    ...
    '</symbol>',
    '<symbol id="icon-iconic-sun-fill" viewBox="0 0 32 32">' +
    '<path d="M16.001 8c-4.418 0-8 3.582-8 8s3.582 8 8 8c4.418 0 7.999-3.582 7.999-8s-3.581-8-7.999-8v0zM14 2c0-1.105 0.895-2 2-2s2 0.895 2 2c0 1.105-0.895 2-2 2s-2-0.895-2-2zM4 6c0-1.105 0.895-2 2-2s2 0.895 2 2c0 1.105-0.895 2-2 2s-2-0.895-2-2zM2 14c1.105 0 2 0.895 2 2 0 1.107-0.895 2-2 2s-2-0.893-2-2c0-1.105 0.895-2 2-2zM4 26c0-1.105 0.895-2 2-2s2 0.895 2 2c0 1.105-0.895 2-2 2s-2-0.895-2-2zM14 30c0-1.109 0.895-2 2-2 1.108 0 2 0.891 2 2 0 1.102-0.892 2-2 2-1.105 0-2-0.898-2-2zM24 26c0-1.105 0.895-2 2-2s2 0.895 2 2c0 1.105-0.895 2-2 2s-2-0.895-2-2zM30 18c-1.104 0-2-0.896-2-2 0-1.107 0.896-2 2-2s2 0.893 2 2c0 1.104-0.896 2-2 2zM24 6c0-1.105 0.895-2 2-2s2 0.895 2 2c0 1.105-0.895 2-2 2s-2-0.895-2-2z"></path>' +
    '</symbol>',
    '<symbol id="icon-iconic-moon-stroke" viewBox="0 0 32 32">' +
    ...
    '</symbol>',
    '<symbol id="icon-iconic-moon-fill" viewBox="0 0 32 32">' +
    '<path d="M24.633 22.184c-8.188 0-14.82-6.637-14.82-14.82 0-2.695 0.773-5.188 2.031-7.363-6.824 1.968-11.844 8.187-11.844 15.644 0 9.031 7.32 16.355 16.352 16.355 7.457 0 13.68-5.023 15.648-11.844-2.18 1.254-4.672 2.028-7.367 2.028z"></path>' +
    '</symbol>',
    '<symbol id="icon-iconic-cloud" viewBox="0 0 32 32">' +
    ...
    '</symbol>',
    '<symbol id="icon-iconic-rain" viewBox="0 0 32 32">' +
    '<path d="M23.998 6c-0.375 0-0.733 0.061-1.103 0.111-1.389-2.465-3.969-4.111-6.895-4.111-2.987 0-5.565 1.666-6.94 4.1-0.353-0.047-0.705-0.1-1.060-0.1-4.41 0-8 3.588-8 8s3.59 8 8 8h15.998c4.414 0 8-3.588 8-8s-3.586-8-8-8zM23.998 18h-15.998c-2.207 0-4-1.795-4-4 0-2.193 1.941-3.885 4.004-3.945 0.009 0.943 0.172 1.869 0.5 2.744l3.746-1.402c-0.168-0.444-0.25-0.915-0.25-1.397 0-2.205 1.793-4 4-4 1.293 0 2.465 0.641 3.199 1.639-1.928 1.461-3.199 3.756-3.199 6.361h4c0-2.205 1.795-4 3.998-4 2.211 0 4 1.795 4 4s-1.789 4-4 4zM3.281 29.438c-0.75 0.75-1.969 0.75-2.719 0s-0.75-1.969 0-2.719 5.438-2.719 5.438-2.719-1.969 4.688-2.719 5.438zM11.285 29.438c-0.75 0.75-1.965 0.75-2.719 0-0.75-0.75-0.75-1.969 0-2.719 0.754-0.75 5.438-2.719 5.438-2.719s-1.965 4.688-2.719 5.438zM19.28 29.438c-0.75 0.75-1.969 0.75-2.719 0s-0.75-1.969 0-2.719 5.437-2.719 5.437-2.719-1.968 4.688-2.718 5.438z"></path>' +
    '</symbol>',
    '<symbol id="icon-iconic-umbrella" viewBox="0 0 32 32">' +
    '<path d="M16 0c-8.82 0-16 7.178-16 16h4c0-0.826 0.676-1.5 1.5-1.5 0.828 0 1.5 0.674 1.5 1.5h4c0-0.826 0.676-1.5 1.5-1.5 0.828 0 1.5 0.674 1.5 1.5v10c0 1.102-0.895 2-2 2-1.102 0-2-0.898-2-2h-4c0 3.309 2.695 6 6 6 3.312 0 6-2.691 6-6v-10c0-0.826 0.676-1.5 1.5-1.5 0.828 0 1.498 0.674 1.498 1.5h4c0-0.826 0.68-1.5 1.5-1.5 0.828 0 1.5 0.674 1.5 1.5h4c0-8.822-7.172-16-15.998-16z"></path>' +
    '</symbol>',
    '<symbol id="icon-iconic-star" viewBox="0 0 32 32">' +
    '<path d="M22.137 19.625l9.863-7.625h-12l-4-12-4 12h-12l9.875 7.594-3.875 12.406 10.016-7.68 9.992 7.68z"></path>' +
    '</symbol>',
    '<symbol id="icon-iconic-map-pin-stroke" viewBox="0 0 20 32">' +
    '<path d="M10 4c1.602 0 3.109 0.625 4.242 1.76 1.133 1.131 1.758 2.638 1.758 4.24s-0.625 3.109-1.73 4.213c-0.168 0.166-2.238 2.225-4.27 5.441-2.023-3.211-4.086-5.262-4.242-5.414-1.133-1.131-1.758-2.638-1.758-4.24s0.625-3.109 1.758-4.242 2.64-1.758 4.242-1.758M10 0c-2.559 0-5.117 0.977-7.070 2.93-3.906 3.904-3.906 10.236 0 14.141 0-0.001 7.070 6.929 7.070 14.929 0-8 7.070-14.93 7.070-14.93 3.906-3.904 3.906-10.236 0-14.141-1.953-1.952-4.511-2.929-7.070-2.929v0zM8 10c0-1.105 0.895-2 2-2s2 0.895 2 2c0 1.105-0.895 2-2 2s-2-0.895-2-2z"></path>' +
    '</symbol>',
    '<symbol id="icon-iconic-map-pin-fill" viewBox="0 0 20 32">' +
    ...
    '</symbol>',
    '<symbol id="icon-iconic-map-pin-alt" viewBox="0 0 16 32">' +
    '<path d="M8 0c-4.418 0-8 3.582-8 8s8 24 8 24 8-19.582 8-24-3.582-8-8-8zM8 12c-2.209 0-4-1.791-4-4s1.791-4 4-4 4 1.791 4 4-1.791 4-4 4z"></path>' +
    '</symbol>',
    '<symbol id="icon-iconic-target" viewBox="0 0 32 32">' +
    ...
    '</symbol>',
    '<symbol id="icon-iconic-download" viewBox="0 0 24 32">' +
    '<path d="M0 28h24v4h-24zM16 18v-18h-8v18h-4l8 10 8-10z"></path>' +
    '</symbol>',
    '<symbol id="icon-iconic-upload" viewBox="0 0 24 32">' +
    '<path d="M0 0h24v4h-24zM8 14v18h8v-18h4l-8-10-8 10z"></path>' +
    '</symbol>',
    '<symbol id="icon-iconic-cloud-download" viewBox="0 0 32 32">' +
    ...
    '</symbol>',
    '<symbol id="icon-iconic-cloud-upload" viewBox="0 0 32 32">' +
    ...
    '</symbol>',
    '<symbol id="icon-iconic-fork" viewBox="0 0 28 32">' +
    ...
    '</symbol>',
    '<symbol id="icon-iconic-paperclip" viewBox="0 0 32 32">' +
